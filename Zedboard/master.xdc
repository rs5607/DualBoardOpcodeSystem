...
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN AB6 [get_ports {JA1}];  # "JC1_N"
set_property PACKAGE_PIN AB7 [get_ports {SCLK}];  # "JC1_P"
#set_property PACKAGE_PIN AA4 [get_ports {JA3}];  # "JC2_N"
set_property PACKAGE_PIN Y4  [get_ports {MOSI}];  # "JC2_P"
#set_property PACKAGE_PIN T6  [get_ports {JC7}];  # "JC3_N"
set_property PACKAGE_PIN R6  [get_ports {MISO}];  # "JC3_P"
#set_property PACKAGE_PIN U4  [get_ports {JC9}];  # "JC4_N"
set_property PACKAGE_PIN T4  [get_ports {SS}];  # "JC4_P"

# ----------------------------------------------------------------------------
# JD Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN W7 [get_ports {SPI_SI}];  # "JD1_N"
set_property PACKAGE_PIN V7 [get_ports {TX}];  # "JD1_P"
#set_property PACKAGE_PIN V4 [get_ports {JB3}];  # "JD2_N"
set_property PACKAGE_PIN V5 [get_ports {RX}];  
#set_property PACKAGE_PIN W5 [get_ports {JD7}];  # "JD3_N"
set_property PACKAGE_PIN W6 [get_ports {SPI_SI}];  # "JD3_P"
#set_property PACKAGE_PIN U5 [get_ports {JD9}];  # "JD4_N"
#set_property PACKAGE_PIN U6 [get_ports {JD10}];  # "JD4_P"
